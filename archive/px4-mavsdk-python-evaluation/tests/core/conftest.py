...
# =============================================================================
# MAVSDK MOCK SETUP (Module-Level Fixtures)
# =============================================================================
# This file uses a special pattern: mocking BEFORE imports happen.
...
mock_offboard.OffboardError = Exception  # Exception class for offboard errors
...
# This allows core tests to run without needing the actual MAVSDK installed.
