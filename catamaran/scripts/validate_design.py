...
Run from the catamaran root (or anywhere) with the project's Python:

    python scripts/validate_design.py
    python scripts/validate_design.py --json
"""
...
# CAD package root (sources live under hardware/cad/, not next to this script)
ROOT = Path(__file__).resolve().parent.parent / "hardware" / "cad"
PART_DIRS = (
    ROOT,
    ROOT / "hull",
    ROOT / "jetdrive",
