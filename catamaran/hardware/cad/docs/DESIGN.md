...
> Authoritative design contract for all parts in `hardware/cad/`. Implements **Kimi's plan**
...
- **Helical blades** (not flat plates): axial loft with 120° twist + tip camber, topology from Jiri Dobry waterJet (`docs/designs/jdobry-waterjet`), scaled to Ø28 tunnel; OD 27 (chamber−1).
